...
/// Creates NetworkManager connections with proper vi{VMID} naming for proactive system
...
/// Legacy function for backward compatibility - creates connections with dyn- naming
/// This should not be used in the new proactive system
